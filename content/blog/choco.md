...
To illustrate this view, here's a toy project called [Choco](https://github.com/junrui-liu/choco) that I built for composing music in the style of [Baroque four-part chorales](https://en.wikipedia.org/wiki/Four-part_harmony). It was originally developed as a course project for [CS 292C - Computer Aided Reasoning for Software](https://github.com/fredfeng/CS292C/tree/spring-2022), and was motivated by my earlier memory of doing four-part voice leading in a music theory class. I felt at that time that the rules of four-part harmony were rigid enough, and the process so mechanical enough, that it would be possible to automate the process of composing a chorale. Choco is my attempt at doing just that.
