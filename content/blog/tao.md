+++
title = "Running a workshop on leading computer-based labs"
date = "2025-09-25"
...
## Introduction
I was provided with the slides from previous years’ iterations of this workshop, developed by [Ethan Marzban](https://epm027.github.io/), [Zach Sisco](https://zsisco.net/), and other wonderful folks. Based on the existing materials, I inferred that the learning outcomes of this workshop were for attendees to:
...
Here comes the first challenge: every participant is a new face both for me and for other participants, yet we will only cross paths for 50 minutes of our lives, after which we’ll be unlikely to meet again[^1]. Since the last 1/3 of the workshop is group discussion, I needed to break the ice by the time that happened. Luckily, the participants were all in good spirits and willing to contribute, probably due to a combination of (1) they could sense that I’m a newbie at this job, so they were extra supportive of whatever I did/said, (2) some of the opening activities did help build a welcoming and inclusive environment.

[^1]: This was unlike every teaching experience I’ve had, where in each instance I was given at least a couple of weeks to continually teach the same group of students, so I had the luxury of spending the entirety of the first few weeks to break the ice and establish trust with students. 
